    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" :inline="true" label-position="right" label-width="120px" style="width: 600px; margin-left:50px;">
        ...
        <el-form-item label="所在城市" prop="province">
          <el-select v-model="temp.province" class="filter-item" placeholder="请选择所在省份" @change="getProvice($event)">
        ...
        <el-form-item label="" prop="city">
          <el-select v-model="temp.city" class="filter-item" :placeholder="temp.province?'请选择所在城市':'请先选择所在省份'" @change="getCity($event)">
